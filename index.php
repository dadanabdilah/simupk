<?php
  define('BASE_URL', 'http://localhost/simupk/');
?>
    ...
    <section class="content">
      <div class="container-fluid">
        <?php
          ...
          $rules = [
                    'beranda'               => "/",
                    'identitas_upk'         => "/identitas_upk",
                    'identitas_upk_aparat'  => "/identitas_upk/aparat",
                    'identitas_upk_jabatan' => "/identitas_upk/jabatan",
                    'identitas_upk_kredit'  => "/identitas_upk/kredit",
                    'kecamatan'             => "/kecamatan",
                    'desa'                  => "/desa",
                    'pengurus'              => "/pengurus",
                    'akuntansi'             => "/akuntansi",
                    'akuntansi_saldo_awal'  => "/akuntansi/saldo_awal",
                    'akuntansi_modal'  => "/akuntansi/modal",
                    'akuntansi_hibah'  => "/akuntansi/hibah",
                    'akuntansi_tutup_buku'  => "/akuntansi/tutup_buku",
                    'user'  => "/user",
                ];
